 ...
 *  addItems([1,-2,-3]) // -4
 */
const addItems = arr => arr.reduce((total, num) => total += num, 0);
 ...
 */
const flattenArray = array => array.reduce((acc, arr) => acc.concat(arr), []);
...
const generateTally = array => {
  return array.reduce((obj, thing) => {
    obj[thing] = obj[thing] ? obj[thing] += 1 : 1;
    return obj;
  }, {});
}
